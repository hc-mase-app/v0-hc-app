...
export default function ManagerHODashboard() {
  ...
  useEffect(() => {
    if (!isAuthenticated || !user?.role || user.role !== "manager_ho") {
      router.push("/login")
      return
    }
    loadData()
  ...
  if (loading)
    return (
      <DashboardLayout title="Dashboard Manager HO">
        <div className="text-center py-12">Loading...</div>
      </DashboardLayout>
    )

  return (
    <DashboardLayout title="Dashboard Manager Head Office">
      <div className="space-y-6">
        ...
        <Tabs defaultValue="pending" className="space-y-4">
          ...
          <TabsContent value="pending">
            <Card>
              <CardHeader>
                <CardTitle>Pengajuan Cuti PJO Menunggu Persetujuan</CardTitle>
                <CardDescription>
                  Pengajuan cuti dari karyawan level PJO yang memerlukan persetujuan Manager HO
                </CardDescription>
              </CardHeader>
              <CardContent>
              ...
              <CardHeader>
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <CardDescription>Lihat semua pengajuan cuti PJO dari seluruh site</CardDescription>
                  </div>
