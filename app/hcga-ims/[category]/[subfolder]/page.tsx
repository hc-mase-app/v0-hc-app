...
export default function SubfolderPage() {
  ...
  const subfolder = decodeURIComponent(params.subfolder as string)
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] dark">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">{subfolder}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <main className="container mx-auto px-4 py-8 max-w-4xl">
        <DocumentList category={category} subfolder={subfolder} />
      </main>
