...
export default function AtasanDashboard() {
  ...
  const loadData = () => {
    ...
    const pending = Database.getPendingRequestsForAtasanBySiteDept(user.site, user.departemen)
      ...
      if (activeTab === "pending") {
        ...
        setFilteredRequests(
          allRequests.filter((r) => {
            ...
            return history.some((h) => h.approverUserId === user?.id && h.approverRole === "atasan_langsung")
          }),
        )
      }
      return
  ...
  return (
    <DashboardLayout title="Dashboard Atasan Langsung">
